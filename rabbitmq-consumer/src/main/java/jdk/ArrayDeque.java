        ...
        implements Deque<E>, Cloneable, Serializable
{
    ...
    private class DescendingIterator extends java.util.ArrayDeque.DeqIterator {
    ...
    public Spliterator<E> spliterator() {
        return new java.util.ArrayDeque.DeqSpliterator();
    }
    ...
    final class DeqSpliterator implements Spliterator<E> {
        ...
        public java.util.ArrayDeque.DeqSpliterator trySplit() {
            final Object[] es = elements;
            final int i, n;
            return ((n = sub(getFence(), i = cursor, es.length) >> 1) <= 0)
                    ? null
                    : new java.util.ArrayDeque.DeqSpliterator(i, cursor = inc(i, n, es.length));
        }
