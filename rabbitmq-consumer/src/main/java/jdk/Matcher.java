...
public final class Matcher implements MatchResult {
    ...
    Matcher(Pattern parent, CharSequence text) {
        ...
        int parentGroupCount = java.lang.Math.max(parent.capturingGroupCount, 10);
    ...
    private MatchResult toMatchResult(String text) {
        return new java.util.regex.Matcher.ImmutableMatchResult(this.first,
                this.last,
                groupCount(),
                this.groups.clone(),
                text);
    ...
    public java.util.regex.Matcher usePattern(Pattern newPattern) {
        ...
        int parentGroupCount = java.lang.Math.max(newPattern.capturingGroupCount, 10);
        groups = new int[parentGroupCount * 2];
     ...
     * {@code appendReplacement} method of the {@link java.util.regex.Matcher} class.
     ...
     * @since 9
     */
    public java.util.regex.Matcher appendReplacement(StringBuilder sb, String replacement) {
        // If no match, return error
        if (first < 0)
            throw new IllegalStateException("No match available");
        StringBuilder result = new StringBuilder();
