...
public class Collections {
    ...
    static class UnmodifiableSortedSet<E>
            extends java.util.Collections.UnmodifiableSet<E>
        ...
        public SortedSet<E> subSet(E fromElement, E toElement) {
            return new java.util.Collections.UnmodifiableSortedSet<>(ss.subSet(fromElement,toElement));
        }
        public SortedSet<E> headSet(E toElement) {
            return new java.util.Collections.UnmodifiableSortedSet<>(ss.headSet(toElement));
        }
        public SortedSet<E> tailSet(E fromElement) {
            return new java.util.Collections.UnmodifiableSortedSet<>(ss.tailSet(fromElement));
        }
    ...
    public static <T> NavigableSet<T> unmodifiableNavigableSet(NavigableSet<T> s) {
        return new java.util.Collections.UnmodifiableNavigableSet<>(s);
    }
    ...
    static class UnmodifiableNavigableSet<E>
            extends java.util.Collections.UnmodifiableSortedSet<E>
         ...
         */
        private static class EmptyNavigableSet<E> extends java.util.Collections.UnmodifiableNavigableSet<E>
        ...
        { return new java.util.Collections.UnmodifiableNavigableSet<>(ns.descendingSet()); }
        public Iterator<E> descendingIterator()
        { return descendingSet().iterator(); }

        public NavigableSet<E> subSet(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive) {
            return new java.util.Collections.UnmodifiableNavigableSet<>(
    ...
    public static <T> List<T> unmodifiableList(List<? extends T> list) {
        return (list instanceof RandomAccess ?
                new java.util.Collections.UnmodifiableRandomAccessList<>(list) :
                new java.util.Collections.UnmodifiableList<>(list));
    }
    ...
    static class UnmodifiableList<E> extends java.util.Collections.UnmodifiableCollection<E>
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            return new java.util.Collections.UnmodifiableList<>(list.subList(fromIndex, toIndex));
        }
            ...
            implements RandomAccess
    {
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            return new java.util.Collections.UnmodifiableRandomAccessList<>(
    ...
    private static class UnmodifiableMap<K,V> implements Map<K,V>, Serializable {
        ...
        public Set<Map.Entry<K,V>> entrySet() {
            if (entrySet==null)
                entrySet = new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet<>(m.entrySet());
            return entrySet;
        }
        ...
        static class UnmodifiableEntrySet<K,V>
                extends java.util.Collections.UnmodifiableSet<Entry<K,V>> {
            ...
            static <K, V> Consumer<Map.Entry<? extends K, ? extends V>> entryConsumer(
                ...
                return e -> action.accept(new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(e));
            }
            ...
            static final class UnmodifiableEntrySetSpliterator<K, V>
                ...
                public Spliterator<Entry<K, V>> trySplit() {
                    ...
                    return split == null
                            ? null
                            : new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntrySetSpliterator<>(split);
                }
            ...
            public Spliterator<Entry<K,V>> spliterator() {
                return new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntrySetSpliterator<>(
            ...
            public Iterator<Map.Entry<K,V>> iterator() {
                return new Iterator<Map.Entry<K,V>>() {
                    ...
                    public Map.Entry<K,V> next() {
                        return new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(i.next());
                    }
                    public void remove() {
                        throw new UnsupportedOperationException();
                    }
            ...
            public Object[] toArray() {
                ...
                for (int i=0; i<a.length; i++)
                    a[i] = new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>((Map.Entry<? extends K, ? extends V>)a[i]);
                return a;
            }
            ...
            public <T> T[] toArray(T[] a) {
                ...
                for (int i=0; i<arr.length; i++)
                    arr[i] = new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>((Map.Entry<? extends K, ? extends V>)arr[i]);
            ...
            public boolean contains(Object o) {
                if (!(o instanceof Map.Entry))
                    return false;
                return c.contains(
                        new java.util.Collections.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>((Map.Entry<?,?>) o));
            }
    ...
    static class UnmodifiableSortedMap<K,V>
            extends java.util.Collections.UnmodifiableMap<K,V>
        ...
        { return new java.util.Collections.UnmodifiableSortedMap<>(sm.subMap(fromKey, toKey)); }
        public SortedMap<K,V> headMap(K toKey)
        { return new java.util.Collections.UnmodifiableSortedMap<>(sm.headMap(toKey)); }
        public SortedMap<K,V> tailMap(K fromKey)
        { return new java.util.Collections.UnmodifiableSortedMap<>(sm.tailMap(fromKey)); }
    ...
    public static <K,V> NavigableMap<K,V> unmodifiableNavigableMap(NavigableMap<K, ? extends V> m) {
        return new java.util.Collections.UnmodifiableNavigableMap<>(m);
    }
    ...
    static class UnmodifiableNavigableMap<K,V>
         ...
         */
        private static class EmptyNavigableMap<K,V> extends java.util.Collections.UnmodifiableNavigableMap<K,V>
                implements Serializable {
         ...
         */
        private static final java.util.Collections.UnmodifiableNavigableMap.EmptyNavigableMap<?,?> EMPTY_NAVIGABLE_MAP =
                new java.util.Collections.UnmodifiableNavigableMap.EmptyNavigableMap<>();
    ...
    static class SynchronizedSortedSet<E>
            extends java.util.Collections.SynchronizedSet<E>
            implements SortedSet<E>
    {
        ...
        public SortedSet<E> subSet(E fromElement, E toElement) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedSortedSet<>(
                        ss.subSet(fromElement, toElement), mutex);
            }
        }
        public SortedSet<E> headSet(E toElement) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedSortedSet<>(ss.headSet(toElement), mutex);
            }
        }
        public SortedSet<E> tailSet(E fromElement) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedSortedSet<>(ss.tailSet(fromElement),mutex);
            }
        }
    ...
    public static <T> NavigableSet<T> synchronizedNavigableSet(NavigableSet<T> s) {
        return new java.util.Collections.SynchronizedNavigableSet<>(s);
    }
    ...
    static class SynchronizedNavigableSet<E>
            extends java.util.Collections.SynchronizedSortedSet<E>
            implements NavigableSet<E>
    {
        ...
        public NavigableSet<E> descendingSet() {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(ns.descendingSet(), mutex);
            }
        }
        ...
        public NavigableSet<E> subSet(E fromElement, E toElement) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(ns.subSet(fromElement, true, toElement, false), mutex);
            }
        }
        public NavigableSet<E> headSet(E toElement) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(ns.headSet(toElement, false), mutex);
            }
        }
        public NavigableSet<E> tailSet(E fromElement) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(ns.tailSet(fromElement, true), mutex);
            }
        }

        public NavigableSet<E> subSet(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(ns.subSet(fromElement, fromInclusive, toElement, toInclusive), mutex);
            }
        }

        public NavigableSet<E> headSet(E toElement, boolean inclusive) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(ns.headSet(toElement, inclusive), mutex);
            }
        }

        public NavigableSet<E> tailSet(E fromElement, boolean inclusive) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(ns.tailSet(fromElement, inclusive), mutex);
            }
        }
    }
    ...
    public static <T> List<T> synchronizedList(List<T> list) {
        return (list instanceof RandomAccess ?
                new java.util.Collections.SynchronizedRandomAccessList<>(list) :
                new java.util.Collections.SynchronizedList<>(list));
    }

    static <T> List<T> synchronizedList(List<T> list, Object mutex) {
        return (list instanceof RandomAccess ?
                new java.util.Collections.SynchronizedRandomAccessList<>(list, mutex) :
                new java.util.Collections.SynchronizedList<>(list, mutex));
    }
    ...
    static class SynchronizedList<E>
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedList<>(list.subList(fromIndex, toIndex),
                        mutex);
            }
        }
    ...
    static class SynchronizedRandomAccessList<E>
            extends java.util.Collections.SynchronizedList<E>
            implements RandomAccess {
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedRandomAccessList<>(
    ...
    private static class SynchronizedMap<K,V>
        ...
        public Set<K> keySet() {
            synchronized (mutex) {
                if (keySet==null)
                    keySet = new java.util.Collections.SynchronizedSet<>(m.keySet(), mutex);
                return keySet;
            }
        }
        ...
        public Set<Map.Entry<K,V>> entrySet() {
            synchronized (mutex) {
                if (entrySet==null)
                    entrySet = new java.util.Collections.SynchronizedSet<>(m.entrySet(), mutex);
                return entrySet;
            }
        }
        ...
        public Collection<V> values() {
            synchronized (mutex) {
                if (values==null)
                    values = new java.util.Collections.SynchronizedCollection<>(m.values(), mutex);
                return values;
            }
        }
    ...
    static class SynchronizedSortedMap<K,V>
            extends java.util.Collections.SynchronizedMap<K,V>
            implements SortedMap<K,V>
    {
        ...
        public SortedMap<K,V> subMap(K fromKey, K toKey) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedSortedMap<>(
                        sm.subMap(fromKey, toKey), mutex);
            }
        }
        public SortedMap<K,V> headMap(K toKey) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedSortedMap<>(sm.headMap(toKey), mutex);
            }
        }
        public SortedMap<K,V> tailMap(K fromKey) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedSortedMap<>(sm.tailMap(fromKey),mutex);
            }
        }
    ...
    public static <K,V> NavigableMap<K,V> synchronizedNavigableMap(NavigableMap<K,V> m) {
        return new java.util.Collections.SynchronizedNavigableMap<>(m);
    }
            ...
            implements NavigableMap<K,V>
    {
        ...
        public NavigableMap<K, V> descendingMap() {
            synchronized (mutex) {
                return
                        new java.util.Collections.SynchronizedNavigableMap<>(nm.descendingMap(), mutex);
            }
        }
        ...
        public NavigableSet<K> navigableKeySet() {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(nm.navigableKeySet(), mutex);
            }
        }

        public NavigableSet<K> descendingKeySet() {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableSet<>(nm.descendingKeySet(), mutex);
            }
        }
        ...
        public SortedMap<K,V> subMap(K fromKey, K toKey) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableMap<>(
                        nm.subMap(fromKey, true, toKey, false), mutex);
            }
        }
        public SortedMap<K,V> headMap(K toKey) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableMap<>(nm.headMap(toKey, false), mutex);
            }
        }
        public SortedMap<K,V> tailMap(K fromKey) {
            synchronized (mutex) {
                return new java.util.Collections.SynchronizedNavigableMap<>(nm.tailMap(fromKey, true),mutex);
            }
        }
    ...
    public static <E> Queue<E> checkedQueue(Queue<E> queue, Class<E> type) {
        return new java.util.Collections.CheckedQueue<>(queue, type);
    }
    ...
    static class CheckedQueue<E>
            extends java.util.Collections.CheckedCollection<E>
    ...
    public static <E> NavigableSet<E> checkedNavigableSet(NavigableSet<E> s,
                                                          Class<E> type) {
        return new java.util.Collections.CheckedNavigableSet<>(s, type);
    }
    ...
    public static <E> List<E> checkedList(List<E> list, Class<E> type) {
        return (list instanceof RandomAccess ?
                new java.util.Collections.CheckedRandomAccessList<>(list, type) :
                new java.util.Collections.CheckedList<>(list, type));
    }
            ...
            implements List<E>
    {
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            return new java.util.Collections.CheckedList<>(list.subList(fromIndex, toIndex), type);
        }
            ...
            implements RandomAccess
    {
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            return new java.util.Collections.CheckedRandomAccessList<>(
            ...
            implements Map<K,V>, Serializable
    {
        ...
        public Set<Map.Entry<K,V>> entrySet() {
            if (entrySet==null)
                entrySet = new java.util.Collections.CheckedMap.CheckedEntrySet<>(m.entrySet(), valueType);
            return entrySet;
        }
        ...
        static class CheckedEntrySet<K,V> implements Set<Map.Entry<K,V>> {
            ...
            public boolean contains(Object o) {
                ...
                Map.Entry<?,?> e = (Map.Entry<?,?>) o;
                return s.contains(
                        (e instanceof java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry) ? e : checkedEntry(e, valueType));
            }
            ...
            static <K,V,T> java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<K,V,T> checkedEntry(Map.Entry<K,V> e,
                                                                                                             Class<T> valueType) {
                return new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(e, valueType);
            }
    ...
    public static <K,V> NavigableMap<K,V> checkedNavigableMap(NavigableMap<K, V> m,
                                                              Class<K> keyType,
                                                              Class<V> valueType) {
        return new java.util.Collections.CheckedNavigableMap<>(m, keyType, valueType);
    }
            ...
            implements NavigableMap<K,V>, Serializable
    {
        ...
        public Entry<K, V> lowerEntry(K key) {
            ...
            return (null != lower)
                    ? new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(lower, valueType)
                    : null;
        }
        ...
        public Entry<K, V> floorEntry(K key) {
            ...
            return (null != floor)
                    ? new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(floor, valueType)
                    : null;
        }
        ...
        public Entry<K, V> ceilingEntry(K key) {
            ...
            return (null != ceiling)
                    ? new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(ceiling, valueType)
                    : null;
        }
        ...
        public Entry<K, V> higherEntry(K key) {
            ...
            return (null != higher)
                    ? new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(higher, valueType)
                    : null;
        }
        ...
        public Entry<K, V> firstEntry() {
            ...
            return (null != first)
                    ? new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(first, valueType)
                    : null;
        }
        ...
        public Entry<K, V> lastEntry() {
            ...
            return (null != last)
                    ? new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(last, valueType)
                    : null;
        }
        ...
        public Entry<K, V> pollFirstEntry() {
            ...
            return (null == entry)
                    ? null
                    : new java.util.Collections.CheckedMap.CheckedEntrySet.CheckedEntry<>(entry, valueType);
        }
    ...
    public static <T> Iterator<T> emptyIterator() {
        return (Iterator<T>) java.util.Collections.EmptyIterator.EMPTY_ITERATOR;
    }

    private static class EmptyIterator<E> implements Iterator<E> {
        static final java.util.Collections.EmptyIterator<Object> EMPTY_ITERATOR
    ...
    public static <T> ListIterator<T> emptyListIterator() {
        return (ListIterator<T>) java.util.Collections.EmptyListIterator.EMPTY_ITERATOR;
    }

    private static class EmptyListIterator<E>
            extends java.util.Collections.EmptyIterator<E>
            implements ListIterator<E>
    {
        static final java.util.Collections.EmptyListIterator<Object> EMPTY_ITERATOR
    ...
    public static <T> Enumeration<T> emptyEnumeration() {
        return (Enumeration<T>) java.util.Collections.EmptyEnumeration.EMPTY_ENUMERATION;
    }

    private static class EmptyEnumeration<E> implements Enumeration<E> {
        static final java.util.Collections.EmptyEnumeration<Object> EMPTY_ENUMERATION
                = new java.util.Collections.EmptyEnumeration<>();
    ...
    public static <E> SortedSet<E> emptySortedSet() {
        return (SortedSet<E>) java.util.Collections.UnmodifiableNavigableSet.EMPTY_NAVIGABLE_SET;
    }
    ...
    public static <E> NavigableSet<E> emptyNavigableSet() {
        return (NavigableSet<E>) java.util.Collections.UnmodifiableNavigableSet.EMPTY_NAVIGABLE_SET;
    }
     ...
     */
    @SuppressWarnings("rawtypes")
    public static final List EMPTY_LIST = new java.util.Collections.EmptyList<>();
     ...
     */
    @SuppressWarnings("rawtypes")
    public static final Map EMPTY_MAP = new java.util.Collections.EmptyMap<>();
    ...
    public static final <K,V> SortedMap<K,V> emptySortedMap() {
        return (SortedMap<K,V>) java.util.Collections.UnmodifiableNavigableMap.EMPTY_NAVIGABLE_MAP;
    }
    ...
    public static final <K,V> NavigableMap<K,V> emptyNavigableMap() {
        return (NavigableMap<K,V>) java.util.Collections.UnmodifiableNavigableMap.EMPTY_NAVIGABLE_MAP;
    }
            ...
            implements RandomAccess, Serializable
    {
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            ...
            if (fromIndex > toIndex)
                throw new IllegalArgumentException("fromIndex(" + fromIndex +
                        ") > toIndex(" + toIndex + ")");
            return new java.util.Collections.CopiesList<>(toIndex - fromIndex, element);
        }
        ...
        public boolean equals(Object o) {
            if (o == this)
                return true;
            if (o instanceof java.util.Collections.CopiesList) {
                java.util.Collections.CopiesList<?> other = (java.util.Collections.CopiesList<?>) o;
    ...
    public static <T> Comparator<T> reverseOrder() {
        return (Comparator<T>) java.util.Collections.ReverseComparator.REVERSE_ORDER;
    }
    ...
    private static class ReverseComparator
        ...
        static final java.util.Collections.ReverseComparator REVERSE_ORDER
                = new java.util.Collections.ReverseComparator();
    ...
    public static <T> Comparator<T> reverseOrder(Comparator<T> cmp) {
        if (cmp == null) {
            ...
            return (Comparator<T>) java.util.Collections.ReverseComparator.REVERSE_ORDER;
        } else if (cmp instanceof java.util.Collections.ReverseComparator2) {
            return ((java.util.Collections.ReverseComparator2<T>) cmp).cmp;
        } else {
            return new java.util.Collections.ReverseComparator2<>(cmp);
        }
    }
            ...
            Serializable
    {
        ...
        public boolean equals(Object o) {
            return (o == this) ||
                    (o instanceof java.util.Collections.ReverseComparator2 &&
                            cmp.equals(((java.util.Collections.ReverseComparator2)o).cmp));
        }
    ...
    public static <E> Set<E> newSetFromMap(Map<E, Boolean> map) {
        return new java.util.Collections.SetFromMap<>(map);
    }
    ...
    public static <T> Queue<T> asLifoQueue(Deque<T> deque) {
        return new java.util.Collections.AsLIFOQueue<>(Objects.requireNonNull(deque));
    }
