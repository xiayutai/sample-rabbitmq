...
public class PriorityQueue<E> extends AbstractQueue<E>
    ...
    public final Spliterator<E> spliterator() {
        return new java.util.PriorityQueue.PriorityQueueSpliterator(0, -1, 0);
    }
    ...
    final class PriorityQueueSpliterator implements Spliterator<E> {
        ...
        public java.util.PriorityQueue.PriorityQueueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid) ? null :
                    new java.util.PriorityQueue.PriorityQueueSpliterator(lo, index = mid, expectedModCount);
        }
